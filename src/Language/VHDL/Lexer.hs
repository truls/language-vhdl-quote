...
vhdlReserved = [ "abs", "access", "after", "alias", "all"
...
vhdlOps = [ "abs", "not", "mod", "rem", "sll", "srl"
          , "sla", "sra", "rol", "ror", "and", "or"
          , "nand", "nor", "xor", "xnor"
          ]
...
identifier = Ident <$> P.identifier lexer
reserved = P.reserved lexer
operator = P.operator lexer
reservedOp = P.reservedOp lexer
charLiteral = CLit <$> P.charLiteral lexer
stringLiteral = SLit <$> P.stringLiteral lexer
